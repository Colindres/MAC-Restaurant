   ...
   <div class="grid_12"> 
    ...
    <nav id="bt-menu" class="bt-menu">
        ...
        <ul>
         ...
         <li class="bt-icon"><a href="index-1.html">Acerca De</a></li>
         <li class="bt-icon"><a href="index-2.html">Menu</a></li>
         <li class="bt-icon"><a href="index-3.html">Blog</a></li>
         <li class="bt-icon"><a href="index-4.html">Reservacion</a></li>
         <li class="current bt-icon"><a href="index-5.html">Contaco</a></li>
        </ul>
      </nav>
      ...
      <div class="grid_8">
        <h3 class="head3">Formulario</h3>
              <form id="form">
                        ...
                        <label class="message">
                        <textarea placeholder="Escríbenos:" data-constraints='@Required @Length(min=20,max=999999)'></textarea>
                        <span class="empty-message">*This field is required.</span>
                        ...
                        <div class="clear"></div>
                        <div class="btns">
                        <a href="#" data-type="reset" class="btn">Eliminar</a>
                        <a href="#" data-type="submit" class="btn">Enviar</a></div>
                        </div>
                        </form>   
      </div>
  </div>
...
<footer>    
  <div class="container_12">
    <div class="grid_6 prefix_3">
      ...
      <div class="copy">
      &copy; 2013 | <a href="#">Politicas de privacidad</a> <br> Sitio Web dise�ado por MAC Corporation <a href="http://www.templatemonster.com/" rel="nofollow">TemplateMonster.com</a>
      </div>
    </div>
  </div>
</footer>
