...
Deneger convallis orci vel mi delaoreet, at ornare lorem consequat. Phasellus era nisl auctor vel velitero. 
    ...
    <div class="grid_3">
      <div class="box maxheight">
        ...
        <div class="title"><a href="http://tablog.hol.es">Mario Tabarini</a></div>
Programador importado desde Nápoles con aspiraciones altas, expectativas moderadas y necesidades minimas. 
      </div>
    </div>
    <div class="grid_3">
      <div class="box maxheight">
        <img src="images/page2_img3.jpg" alt="">
        <div class="title"><a href="http://insidemusic.zz.mu">Omar Agreda</a></div>
    ...
    <div class="grid_3">
      <div class="box maxheight">
        ...
        <div class="title"><a href="http://luisport.esy.es/">Luis Colindres</a></div>
...
<footer>    
  <div class="container_12">
    <div class="grid_6 prefix_3">
      ...
      <div class="copy">
      &copy; 2013 | <a href="#">Privacy Policy</a> <br> Sitio Web diseñando por MAC Corporation<a href="#" rel="nofollow"></a>
      </div>
    </div>
  </div>
</footer>
